-- // Lib \\ --
--[[
    local UI = loadstring(game:HttpGet("https://komarusq.best/assets/files/gayasf.ui2?key=5y1lxXSfWKhlQkSqhUuFyB8kPp8hsCau"))()
]]
-- // Library Init \\ --
local Start = tick()
local LoadTime = tick()
...
do
    ...
    Utility.SaveConfig = function(Config)
        ...
        writefile(
            "komarusq/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json", 
    ...
    Utility.LoadConfig = function(Config)
        local CFG = HttpService:JSONDecode(readfile("komarusq/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json"))
        --
...
do
    function Library.CreateLoader(Title, WindowSize)
        ...
        --
        Library.Theme.Logo = Utility.AddImage("komarusq/Assets/UI/Logo.png", "https://i.imgur.com/MxJ5XMK.png")
        --
        ...
        --
        Utility.AddFolder("komarusq")
        Utility.AddFolder("komarusq/Caches")
        Utility.AddFolder("komarusq/Assets")
        Utility.AddFolder("komarusq/Assets/UI")
        Utility.AddFolder("komarusq/Configs")
        Utility.AddFolder("komarusq/Scripts")
        --
        Library.Theme.Gradient = Utility.AddImage("komarusq/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        -- Library.Theme.SecondIcon = Utility.AddImage("komarusq/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        Library.Theme.Hue = Utility.AddImage("komarusq/Assets/UI/Hue.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/HuePicker.png")
        Library.Theme.Saturation = Utility.AddImage("komarusq/Assets/UI/Saturation.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/SaturationPicker.png")
        Library.Theme.SaturationCursor = Utility.AddImage("komarusq/Assets/UI/HueCursor.png", "https://raw.githubusercontent.com/mvonwalk/splix-assets/main/Images-cursor.png")
        --
        Library.Theme.Dummy = Utility.AddImage("komarusq/Assets/UI/Dummy.png", "https://i.imgur.com/6M6buVv.png")
        Library.Theme.Astolfo = Utility.AddImage("komarusq/Assets/UI/Astolfo.png", "https://i.imgur.com/T20cWY9.png")
        Library.Theme.Aiko = Utility.AddImage("komarusq/Assets/UI/Aiko.png", "https://i.imgur.com/1gRIdko.png")
        Library.Theme.Rem = Utility.AddImage("komarusq/Assets/UI/Rem.png", "https://i.imgur.com/ykbRkhJ.png")
        Library.Theme.Violet = Utility.AddImage("komarusq/Assets/UI/Violet.png", "https://i.imgur.com/7B56w4a.png")
        Library.Theme.Asuka = Utility.AddImage("komarusq/Assets/UI/Asuka.png", "https://i.imgur.com/3hwztNM.png")
        --
        if not isfolder("komarusq/Configs/" .. game.PlaceId) then
            makefolder("komarusq/Configs/" .. game.PlaceId)
        end
        --
        ...
        function Window:Tab(Title)
            ...
            function Tab:Section(Title, Side)
                ...
                function Section:TextBox(Options)
                    ...
                    InputHandler.Name = ("komarusq-INPUT-%s"):format(HttpService:GenerateGUID(false))
                    --
